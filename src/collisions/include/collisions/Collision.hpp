...
/// pixels Supports scaling and rotation AlphaLimit: The threshold at which a pixel
/// becomes "solid". If AlphaLimit is 127, a pixel with alpha value 128 will cause a
/// collision and a pixel with alpha value 126 will not.
///
